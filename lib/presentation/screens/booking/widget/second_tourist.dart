...
class SecondTourist extends StatelessWidget {
  const SecondTourist({super.key, required this.state, required this.event});
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                CustomTextfield(labelText: "Имя"),
                8.verticalSpace,
                CustomTextfield(labelText: "Фамилия"),
                8.verticalSpace,
